...
var _splitHtmlToChars = __webpack_require__(3);
...
(0, _jquery2.default)('#fullpage').fullpage({
    ...
    onLeave: function onLeave(index, nextIndex, direction) {
        ...
        var top = (0, _jquery2.default)('section').eq(index).find('h2 span');
        var bottom = (0, _jquery2.default)('section').eq(index).find('.section-bottom');
        var progress = (0, _jquery2.default)('.circle');

        tl.staggerFromTo(top, .6, { x: 250, opacity: 0 }, { x: 0, opacity: 1, ease: Back.easeOut.config(2) }, .3).fromTo(bottom, .45, { y: 100, opacity: 0 }, { y: 0, opacity: 1, ease: Back.easeOut.config(2) }, 1);
        ...
        if (direction === 'down' && current === 2) {
            _jquery2.default.fn.fullpage.setAllowScrolling(false, 'down');
        } else {
            _jquery2.default.fn.fullpage.setAllowScrolling(true, 'down');
        }
    }
});

// show looser text
(0, _jquery2.default)('.btn-looser').click(function () {
    (0, _jquery2.default)(this).hide().siblings().hide();
    (0, _jquery2.default)('.section-title').hide();
    (0, _jquery2.default)('.choose').hide();
    (0, _jquery2.default)('.looser-text').show();
    (0, _jquery2.default)('.circle').addClass('looser');
    tl.staggerTo('svg path', 0.2, { opacity: 1 }, 0.2).staggerFromTo('.looser .letter', 0.3, { x: 40, visibility: 'hidden' }, { x: 0, visibility: 'visible', ease: Back.easeOut.config(2) }, 0.05).fromTo('.not-looser', .45, { y: 100, opacity: 0, display: 'none' }, { y: 0, opacity: 1, display: 'block', ease: Back.easeOut.config(2) });
    _jquery2.default.fn.fullpage.setAllowScrolling(false);
});

// miss looser text
(0, _jquery2.default)('.next-slide').click(function () {
    _jquery2.default.fn.fullpage.moveSectionDown();
});

// back to game
(0, _jquery2.default)('.not-looser').click(function () {
    (0, _jquery2.default)('.circle').removeClass('looser');
    tl.staggerTo('svg path', 0.3, { opacity: .2 }, 0.1).staggerTo('.looser .letter', 0.3, { visibility: 'hidden' }).staggerTo('.choose', 0.3, { display: 'block' }, 0.1);
    setTimeout(function () {
        _jquery2.default.fn.fullpage.moveSectionDown();
    }, 500);
    (0, _jquery2.default)('.section-title').show();
    tl.staggerFromTo('.section.active .section-title span', .6, { x: 250, opacity: 0 }, { x: 0, opacity: 1, ease: Back.easeOut.config(2) }, .3);
    (0, _jquery2.default)(this).hide().siblings().show();
...
// start animation
var tl = new _gsap.TimelineMax();
tl.set('.circle-grey, .circle-black', { transformOrigin: '50% 50%', rotation: -90 }).fromTo('.circle-grey', 1.2, { strokeDashoffset: 2290 }, { strokeDashoffset: 0, ease: Power0.easeNone }, 0).staggerFromTo('.section-title.intro span', .6, { x: 250, opacity: 0 }, { x: 0, opacity: 1, ease: Back.easeOut.config(2) }, .2).fromTo('.section-bottom.intro', .45, { y: 100, opacity: 0 }, { y: 0, opacity: 1, ease: Back.easeOut.config(2) }, 1.8);
